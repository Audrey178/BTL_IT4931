...
conda create --name airflow_env python=3.10 -y
conda activate airflow_env

# 2. Cài đặt các thư viện cần thiết:
pip install "apache-airflow==3.1.1" --constraint "https://raw.githubusercontent.com/apache/airflow/constraints-3.1.1/constraints-3.10.txt"
